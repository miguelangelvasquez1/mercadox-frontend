...
export default function RecoverPasswordPage() {
  return (
    <div style={{ minHeight: '100vh', background: T.bg, color: T.text, fontFamily: T.fontBody, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      ...
      >
        <p style={{ color: T.accent, fontSize: 12, fontWeight: 700, marginBottom: 10 }}>RECOVERY</p>
        <h1 style={{ fontFamily: T.fontDisplay, fontSize: '2rem', marginBottom: 12 }}>Recuperación no disponible aún</h1>
        <p style={{ color: T.muted, lineHeight: 1.7, marginBottom: 22 }}>
          Esta ruta ya existe en el frontend para evitar errores, pero tu backend actual no expone recuperación de contraseña.
        </p>
